...
const HomeContainer =({sharedState})=> {
    const description =`
    <li>Currently working full time at <b>BenchMark Gensuite &#174;	</b></li>
    <li>2+ years in Coldfusion,HTML/CSS/JS,Jquery,React,Nextjs,Tailwind.</li>`;
    return (
            ...
            <div className="flex">
              ...
              <div className='mobileHeight lg:hidden xl:hidden  2xl:hidden md:hidden sm:block block  '> 
                ...
                <Image
                  ...
                  />
                <div className='mx-2 shadow-xl rounded-xl text-sm font-bold font-ubuntu p-6 bg-white text-black absolute bottom-2 left-0 right-0 transition-transform transform hover:-translate-y-1 hover:shadow-md overflow-y-scroll h-1/6'>
                  {HTMLReactParser(description)}
                </div>
              </div>
            </div>
